...
\usepackage{soul}%\underline non fa il word wrapping, si usa \ul
...
\ul{\begin{CJK*}{UTF8}{gbsn}楚怀王\end{CJK*} 
Chǔ Huáiwáng}, come 
\ul{\begin{CJK*}{UTF8}{gbsn}左徒 \end{CJK*}
zuǒtú}, ministro di sinistra.\footnote{Lanciotti, \emph{Letteratura cinese}, 60.} Allora il regno di 
\ul{\begin{CJK*}{UTF8}{gbsn}楚 \end{CJK*}
...
\section{Opera}
Il 
\ul{\begin{CJK*}{UTF8}{gbsn}离骚\end{CJK*}
 Lí Sāo} è uno dei più antichi poemi cinesi, ed è incluso nei 
 \ul{\begin{CJK*}{UTF8}{gbsn}楚辞 \end{CJK*}
...
\ul{\begin{CJK*}{UTF8}{gbsn}兮 \end{CJK*}
...
Il termine 
\ul{\begin{CJK*}{UTF8}{gbsn}骚 \end{CJK*} sāo} significa “pena, “dolore”, ma con il  
...
\ul{\begin{CJK*}{UTF8}{gbsn}秦 \end{CJK*} Qín},
...
\ul{\begin{CJK*}{UTF8}{gbsn}宾客 \end{CJK*} bīnkè} (ospiti) o
