...
\underline{\begin{CJK*}{UTF8}{gbsn}楚怀王\end{CJK*} 
Chǔ Huáiwáng}, come 
\underline{\begin{CJK*}{UTF8}{gbsn}左徒 \end{CJK*}
zuǒtú}, ministro di sinistra.\footnote{Lanciotti, \emph{Letteratura cinese}, 60.} Allora il regno di 
\underline{\begin{CJK*}{UTF8}{gbsn}楚 \end{CJK*}
...
\section{Opera}
Il 
\underline{\begin{CJK*}{UTF8}{gbsn}离骚\end{CJK*}
 Lí Sāo} è uno dei più antichi poemi cinesi, ed è incluso nei 
 \underline{\begin{CJK*}{UTF8}{gbsn}楚辞 \end{CJK*}
...
\begin{adjustwidth}{-2cm}{-2cm}%toglie 2 cm a sx e 2 cm a dx
...
\underline{\begin{CJK*}{UTF8}{gbsn}兮 \end{CJK*}
...
Il termine 
\underline{\begin{CJK*}{UTF8}{gbsn}骚 \end{CJK*} sāo} significa “pena, “dolore”, ma con il  
...
\underline{\begin{CJK*}{UTF8}{gbsn}秦 \end{CJK*} Qín},
...
\underline{\begin{CJK*}{UTF8}{gbsn}宾客 \end{CJK*} bīnkè} (ospiti) o
